...
from Pregunta8 import Ui_Pregunta8
from Funciones_Auxiliares import suma_vectorial

class Ui_Pregunta7(QWidget,object):
    def setupUi(self, Pregunta7, lista_sustancias_escogidas,lista_puntajes_pregunta_anterior):
        self.Lista_sustancias_Escogidas = lista_sustancias_escogidas
        self.puntajes_recibidos = lista_puntajes_pregunta_anterior
        Pregunta7.setObjectName("Pregunta6")
        Pregunta7.resize(1924, 1089)
        self.BannerLabel = QtWidgets.QLabel(Pregunta7)
        ...
        self.LabelInstruccion = QtWidgets.QLabel(Pregunta7)
        self.LabelInstruccion.setGeometry(QtCore.QRect(220, 156, 1831, 51))
        font = QtGui.QFont()
        ...
        self.LabelInstruccion.setText(
            "7. ¿Ha intentado alguna vez controlar, reducir o dejar de consumir la sustancia y no lo ha logrado?")
        self.progressBar = QtWidgets.QProgressBar(Pregunta7)
        ...
        self.progressBar.setStyleSheet("QProgressBar::chunk {\n"
                                       ...
                                       "  border-radius: 20px;\n"
                                       "}")
        self.progressBar.setProperty("value", 84)
        self.progressBar.setTextVisible(False)
        self.progressBar.setObjectName("progressBar")
        self.pushButton = QtWidgets.QPushButton(Pregunta7)
        ...
        self.pushButton.clicked.connect(self.abrir_pregunta8)
        ...
        if self.canitdad_sustancias == 1:
            self.SustanciaFrame = QtWidgets.QFrame(Pregunta7)
            ...
            QtCore.QMetaObject.connectSlotsByName(Pregunta7)

            _translate = QtCore.QCoreApplication.translate
            Pregunta7.setWindowTitle(_translate("Pregunta7", "Pregunta7"))
            self.pushButton.setText(_translate("Pregunta7", "SIGUIENTE PREGUNTA"))
            self.LabelSustancia.setText(_translate("Pregunta7", "Cannabis"))
            self.SeleccionNoNunca.setText(_translate("Pregunta7", "No,Nunca"))
            self.SeleccionSiEnLosUltimos3Meses.setText(_translate("Pregunta7", "Si, en los ultimos 3 meses"))
            self.SeleccionSiPeroNoEnLosUltimos3Meses.setText(_translate("Pregunta7", "Si, pero no en los ultimos 3 meses"))
        ...
        if self.canitdad_sustancias == 2:
            ...
            self.SustanciaFrame2 = QtWidgets.QFrame(Pregunta7)
            ...
            Pregunta7.setWindowTitle(_translate("Pregunta7", "Pregunta7"))
            self.pushButton.setText(_translate("Pregunta7", "SIGUIENTE PREGUNTA"))
            self.LabelSustancia.setText(_translate("Pregunta7", f"{lista_sustancias_escogidas[0]}"))
            self.SeleccionNoNunca.setText(_translate("Pregunta7", "No,Nunca"))
            self.SeleccionSiEnLosUltimos3Meses.setText(_translate("Pregunta7", "Si, en los ultimos 3 meses"))
            self.SeleccionSiPeroNoEnLosUltimos3Meses.setText(
                _translate("Pregunta7", "Si, pero no en los ultimos 3 meses"))

            _translate = QtCore.QCoreApplication.translate
            Pregunta7.setWindowTitle(_translate("Pregunta7", "Pregunta7"))
            self.pushButton.setText(_translate("Pregunta7", "SIGUIENTE PREGUNTA"))
            self.LabelSustancia2.setText(_translate("Pregunta7", f"{lista_sustancias_escogidas[1]}"))
            self.SeleccionNoNunca2.setText(_translate("Pregunta7", "No,Nunca"))
            self.SeleccionSiEnLosUltimos3Meses2.setText(_translate("Pregunta7", "Si, en los ultimos 3 meses"))
            self.SeleccionSiPeroNoEnLosUltimos3Meses2.setText(_translate("Pregunta7", "Si, pero no en los ultimos 3 meses"))
        ...
        if self.canitdad_sustancias == 3:
            ...
            self.SustanciaFrame3 = QtWidgets.QFrame(Pregunta7)
            ...
            self.LabelSustancia3.setText(_translate("Pregunta7", f"{lista_sustancias_escogidas[2]}"))
            self.SeleccionNoNunca3.setText(_translate("Pregunta7", "No,Nunca"))
            self.SeleccionSiEnLosUltimos3Meses3.setText(_translate("Pregunta7", "Si, en los ultimos 3 meses"))
            self.SeleccionSiPeroNoEnLosUltimos3Meses3.setText(_translate("Pregunta7", "Si, pero no en los ultimos 3 meses"))
        ...
        if self.canitdad_sustancias == 4:
            ...
            self.SustanciaFrame4 = QtWidgets.QFrame(Pregunta7)
            ...
            self.LabelSustancia4.setText(_translate("Pregunta7", f"{lista_sustancias_escogidas[3]}"))
            self.SeleccionNoNunca4.setText(_translate("Pregunta7", "No,Nunca"))
            self.SeleccionSiEnLosUltimos3Meses4.setText(_translate("Pregunta7", "Si, en los ultimos 3 meses"))
            self.SeleccionSiPeroNoEnLosUltimos3Meses4.setText(_translate("Pregunta7", "Si, pero no en los ultimos 3 meses"))
        ...
        if self.canitdad_sustancias == 5:
            ...
            self.SustanciaFrame5 = QtWidgets.QFrame(Pregunta7)
            ...
            self.LabelSustancia5.setText(_translate("Pregunta7", f"{lista_sustancias_escogidas[4]}"))
            self.SeleccionNoNunca5.setText(_translate("Pregunta7", "No,Nunca"))
            self.SeleccionSiEnLosUltimos3Meses5.setText(_translate("Pregunta7", "Si, en los ultimos 3 meses"))
            self.SeleccionSiPeroNoEnLosUltimos3Meses5.setText(_translate("Pregunta7", "Si, pero no en los ultimos 3 meses"))
        ...
        if self.canitdad_sustancias == 6:
            ...
            self.SustanciaFrame6 = QtWidgets.QFrame(Pregunta7)
            ...
            self.LabelSustancia6.setText(_translate("Pregunta7", f"{lista_sustancias_escogidas[5]}"))
            self.SeleccionNoNunca6.setText(_translate("Pregunta7", "No,Nunca"))
            self.SeleccionSiEnLosUltimos3Meses6.setText(_translate("Pregunta7", "Si, en los ultimos 3 meses"))
            self.SeleccionSiPeroNoEnLosUltimos3Meses6.setText(_translate("Pregunta7", "Si, pero no en los ultimos 3 meses"))

    def abrir_pregunta8(self):
        ...
        print("El puntaje que lleva hasta la pregunta 7x es: ", lista_puntajes_a_pasar)
        self.pregunta8 = QMainWindow()
        self.ui = Ui_Pregunta8()
        self.ui.setupUi(self.pregunta8,self.Lista_sustancias_Escogidas,lista_puntajes_a_pasar)
        self.pregunta8.showFullScreen()
