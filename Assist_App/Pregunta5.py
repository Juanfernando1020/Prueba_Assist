...
from Pregunta6 import Ui_Pregunta6


class Ui_Pregunta5(QWidget,object):
    def setupUi(self, Pregunta5, lista_sustancias_escogidas,lista_puntajes_pregunta_anterior):
        self.puntajes_recibidos = lista_puntajes_pregunta_anterior
        Pregunta5.setObjectName("Pregunta5")
        Pregunta5.resize(1924, 1089)
        self.BannerLabel = QtWidgets.QLabel(Pregunta5)
        ...
        self.LabelInstruccion = QtWidgets.QLabel(Pregunta5)
        ...
        self.LabelInstruccion.setText(
            "5. En los últimos tres meses, ¿con qué frecuencia dejó de hacer lo que se esperaba de usted habitualmente por el consumo de las sustancias?")
        self.progressBar = QtWidgets.QProgressBar(Pregunta5)
        ...
        self.pushButton = QtWidgets.QPushButton(Pregunta5)
        ...
        self.pushButton.clicked.connect(self.abrir_pregunta6)
        ...
        if self.canitdad_sustancias == 1:
            self.SustanciaFrame = QtWidgets.QFrame(Pregunta5)
            ...
            Pregunta5.setWindowTitle(_translate("Pregunta5", "Pregunta5"))
            self.LabelSustancia.setText(_translate(f"Pregunta5", f"{lista_sustancias_escogidas[0]}"))
            self.SeleccionNunca.setText(_translate("Pregunta5", "Nunca"))
            self.Seleccion1o2Veces.setText(_translate("Pregunta5", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes.setText(_translate("Pregunta5", "Cada mes \n"""))
            self.SeleccionCadaSemana.setText(_translate("Pregunta5", "Cada semana"))
            self.radioButton.setText(_translate("Pregunta5", "A diario o casi diario"))
            self.pushButton.setText(_translate("Pregunta5", "SIGUIENTE PREGUNTA"))
            ...
            self.Sustancia2Frame = QtWidgets.QFrame(Pregunta5)
            ...
            QtCore.QMetaObject.connectSlotsByName(Pregunta5)

            _translate = QtCore.QCoreApplication.translate
            Pregunta5.setWindowTitle(_translate("Pregunta5", "Pregunta5"))
            self.LabelSustancia.setText(_translate("Pregunta5", f"{lista_sustancias_escogidas[0]}"))
            self.SeleccionNunca.setText(_translate("Pregunta5", "Nunca"))
            self.Seleccion1o2Veces.setText(_translate("Pregunta5", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes.setText(_translate("Pregunta5", "Cada mes \n"""))
            self.SeleccionCadaSemana.setText(_translate("Pregunta5", "Cada semana"))
            ...
            self.LabelSustancia2.setText(_translate("Pregunta5", f"{lista_sustancias_escogidas[1]}"))
            self.SeleccionNunca2.setText(_translate("Pregunta5", "Nunca"))
            self.Seleccion1o2Veces2.setText(_translate("Pregunta5", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes2.setText(_translate("Pregunta5", "Cada mes \n"""))
            self.SeleccionCadaSemana2.setText(_translate("Pregunta5", "Cada semana"))
            self.radioButton2.setText(_translate("Pregunta5", "A diario o casi diario"))
            ...
            self.Sustancia3Frame = QtWidgets.QFrame(Pregunta5)
            ...
            self.LabelSustancia3.setText(_translate("Pregunta5", f"{lista_sustancias_escogidas[2]}"))
            self.SeleccionNunca3.setText(_translate("Pregunta5", "Nunca"))
            self.Seleccion1o2Veces3.setText(_translate("Pregunta5", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes3.setText(_translate("Pregunta5", "Cada mes \n"""))
            self.SeleccionCadaSemana3.setText(_translate("Pregunta5", "Cada semana"))
            self.radioButton3.setText(_translate("Pregunta5", "A diario o casi diario"))
            ...
            self.Sustancia4Frame = QtWidgets.QFrame(Pregunta5)
            ...
            self.LabelSustancia4.setText(_translate("Pregunta5", f"{lista_sustancias_escogidas[3]}"))
            self.SeleccionNunca4.setText(_translate("Pregunta5", "Nunca"))
            self.Seleccion1o2Veces4.setText(_translate("Pregunta5", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes4.setText(_translate("Pregunta5", "Cada mes \n"""))
            self.SeleccionCadaSemana4.setText(_translate("Pregunta5", "Cada semana"))
            self.radioButton4.setText(_translate("Pregunta5", "A diario o casi diario"))
            ...
            self.Sustancia5Frame = QtWidgets.QFrame(Pregunta5)
            ...
            self.LabelSustancia5.setText(_translate("Pregunta5", f"{lista_sustancias_escogidas[4]}"))
            self.SeleccionNunca5.setText(_translate("Pregunta5", "Nunca"))
            self.Seleccion1o2Veces5.setText(_translate("Pregunta5", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes5.setText(_translate("Pregunta5", "Cada mes \n"""))
            self.SeleccionCadaSemana5.setText(_translate("Pregunta5", "Cada semana"))
            self.radioButton5.setText(_translate("Pregunta5", "A diario o casi diario"))
            ...
            self.Sustancia6Frame = QtWidgets.QFrame(Pregunta5)
            ...
            self.LabelSustancia6.setText(_translate("Pregunta5", f"{lista_sustancias_escogidas[5]}"))
            self.SeleccionNunca6.setText(_translate("Pregunta5", "Nunca"))
            self.Seleccion1o2Veces6.setText(_translate("Pregunta5", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes6.setText(_translate("Pregunta5", "Cada mes \n"""))
            self.SeleccionCadaSemana6.setText(_translate("Pregunta5", "Cada semana"))
            self.radioButton6.setText(_translate("Pregunta5", "A diario o casi diario"))

    def abrir_pregunta6(self):
        ...
        if self.canitdad_sustancias == 1:
            if self.SeleccionNunca.isChecked():
                ...
                puntajes_pregunta_actual.append(8)
        elif self.canitdad_sustancias == 2:
            if self.SeleccionNunca.isChecked():
                puntajes_pregunta_actual.append(0)
            elif self.Seleccion1o2Veces.isChecked():
        ...
        self.pregunta6 = QMainWindow()
        self.ui = Ui_Pregunta6()
        self.ui.setupUi(self.pregunta6, self.Lista_sustancias,lista_puntajes_a_pasar)
        self.pregunta6.showFullScreen()