...
from Pregunta4 import Ui_Pregunta4

class Ui_Pregunta3(QWidget,object):

    def setupUi(self, Pregunta3, lista_sustancias_escogidas,lista_puntajes_pregunta_anterior):
        self.puntajes_recibidos = lista_puntajes_pregunta_anterior
        Pregunta3.setObjectName("Pregunta3")
        Pregunta3.resize(1924, 1089)
        self.BannerLabel = QtWidgets.QLabel(Pregunta3)
        ...
        self.LabelInstruccion = QtWidgets.QLabel(Pregunta3)
        ...
        self.LabelInstruccion.setText(
            "3. ¿En los últimos tres meses, ¿con qué frecuencia ha tenido deseos fuertes o ansias de consumir las siguientes sustancias?")
        self.progressBar = QtWidgets.QProgressBar(Pregunta3)
        ...
        self.pushButton = QtWidgets.QPushButton(Pregunta3)
        ...
        self.pushButton.clicked.connect(self.abrir_pregunta4)
        ...
        if self.canitdad_sustancias == 1:
            self.SustanciaFrame = QtWidgets.QFrame(Pregunta3)
            ...
            Pregunta3.setWindowTitle(_translate("Pregunta3", "Pregunta3"))
            self.LabelSustancia.setText(_translate(f"Pregunta3", f"{lista_sustancias_escogidas[0]}"))
            self.SeleccionNunca.setText(_translate("Pregunta3", "Nunca"))
            self.Seleccion1o2Veces.setText(_translate("Pregunta3", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes.setText(_translate("Pregunta3", "Cada mes \n"""))
            self.SeleccionCadaSemana.setText(_translate("Pregunta3", "Cada semana"))
            self.radioButton.setText(_translate("Pregunta3", "A diario o casi diario"))
            self.pushButton.setText(_translate("Pregunta3", "SIGUIENTE PREGUNTA"))
            ...
            self.Sustancia2Frame = QtWidgets.QFrame(Pregunta3)
            ...
            QtCore.QMetaObject.connectSlotsByName(Pregunta3)

            _translate = QtCore.QCoreApplication.translate
            Pregunta3.setWindowTitle(_translate("Pregunta3", "Pregunta3"))
            self.LabelSustancia.setText(_translate("Pregunta3", f"{lista_sustancias_escogidas[0]}"))
            self.SeleccionNunca.setText(_translate("Pregunta3", "Nunca"))
            self.Seleccion1o2Veces.setText(_translate("Pregunta3", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes.setText(_translate("Pregunta3", "Cada mes \n"""))
            self.SeleccionCadaSemana.setText(_translate("Pregunta3", "Cada semana"))
            ...
            self.LabelSustancia2.setText(_translate("Pregunta3", f"{lista_sustancias_escogidas[1]}"))
            self.SeleccionNunca2.setText(_translate("Pregunta3", "Nunca"))
            self.Seleccion1o2Veces2.setText(_translate("Pregunta3", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes2.setText(_translate("Pregunta3", "Cada mes \n"""))
            self.SeleccionCadaSemana2.setText(_translate("Pregunta3", "Cada semana"))
            self.radioButton2.setText(_translate("Pregunta3", "A diario o casi diario"))
            ...
            self.Sustancia3Frame = QtWidgets.QFrame(Pregunta3)
            ...
            self.LabelSustancia3.setText(_translate("Pregunta3", f"{lista_sustancias_escogidas[2]}"))
            self.SeleccionNunca3.setText(_translate("Pregunta3", "Nunca"))
            self.Seleccion1o2Veces3.setText(_translate("Pregunta3", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes3.setText(_translate("Pregunta3", "Cada mes \n"""))
            self.SeleccionCadaSemana3.setText(_translate("Pregunta3", "Cada semana"))
            ...
            self.Sustancia4Frame = QtWidgets.QFrame(Pregunta3)
            ...
            self.LabelSustancia4.setText(_translate("Pregunta3", f"{lista_sustancias_escogidas[3]}"))
            self.SeleccionNunca4.setText(_translate("Pregunta3", "Nunca"))
            self.Seleccion1o2Veces4.setText(_translate("Pregunta3", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes4.setText(_translate("Pregunta3", "Cada mes \n"""))
            self.SeleccionCadaSemana4.setText(_translate("Pregunta3", "Cada semana"))
            self.radioButton4.setText(_translate("Pregunta3", "A diario o casi diario"))
            ...
            self.Sustancia5Frame = QtWidgets.QFrame(Pregunta3)
            ...
            self.LabelSustancia5.setText(_translate("Pregunta3", f"{lista_sustancias_escogidas[4]}"))
            self.SeleccionNunca5.setText(_translate("Pregunta3", "Nunca"))
            self.Seleccion1o2Veces5.setText(_translate("Pregunta3", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes5.setText(_translate("Pregunta3", "Cada mes \n"""))
            self.SeleccionCadaSemana5.setText(_translate("Pregunta3", "Cada semana"))
            self.radioButton5.setText(_translate("Pregunta3", "A diario o casi diario"))
            ...
            self.Sustancia6Frame = QtWidgets.QFrame(Pregunta3)
            ...
            self.LabelSustancia6.setText(_translate("Pregunta3", f"{lista_sustancias_escogidas[5]}"))
            self.SeleccionNunca6.setText(_translate("Pregunta3", "Nunca"))
            self.Seleccion1o2Veces6.setText(_translate("Pregunta3", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes6.setText(_translate("Pregunta3", "Cada mes \n"""))
            self.SeleccionCadaSemana6.setText(_translate("Pregunta3", "Cada semana"))
            self.radioButton6.setText(_translate("Pregunta3", "A diario o casi diario"))

    def abrir_pregunta4(self):
        ...
        print(lista_puntajes_a_pasar)
        self.pregunta4 = QMainWindow()
        self.ui = Ui_Pregunta4()
        self.ui.setupUi(self.pregunta4, self.Lista_sustancias,lista_puntajes_a_pasar)
        self.pregunta4.showFullScreen()
