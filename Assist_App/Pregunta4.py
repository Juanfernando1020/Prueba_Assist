...
from Pregunta5 import Ui_Pregunta5

class Ui_Pregunta4(QWidget):
    def setupUi(self, Pregunta4, lista_sustancias_escogidas,lista_puntajes_pregunta_anterior):
        self.puntajes_recibidos = lista_puntajes_pregunta_anterior
        Pregunta4.setObjectName("Pregunta4")
        Pregunta4.resize(1924, 1089)
        self.BannerLabel = QtWidgets.QLabel(Pregunta4)
        ...
        self.LabelInstruccion = QtWidgets.QLabel(Pregunta4)
        ...
        self.LabelInstruccion.setText(
            "4. En los últimos tres meses, ¿con qué frecuencia le ha llevado su consumo a problemas de salud, sociales, legales o económicos?")
        self.progressBar = QtWidgets.QProgressBar(Pregunta4)
        ...
        self.pushButton = QtWidgets.QPushButton(Pregunta4)
        ...
        self.pushButton.clicked.connect(self.abrir_pregunta5)
        ...
        if self.canitdad_sustancias == 1:
            self.SustanciaFrame = QtWidgets.QFrame(Pregunta4)
            ...
            Pregunta4.setWindowTitle(_translate("Pregunta4", "Pregunta4"))
            self.LabelSustancia.setText(_translate(f"Pregunta4", f"{lista_sustancias_escogidas[0]}"))
            self.SeleccionNunca.setText(_translate("Pregunta4", "Nunca"))
            self.Seleccion1o2Veces.setText(_translate("Pregunta4", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes.setText(_translate("Pregunta4", "Cada mes \n"""))
            self.SeleccionCadaSemana.setText(_translate("Pregunta4", "Cada semana"))
            self.radioButton.setText(_translate("Pregunta4", "A diario o casi diario"))
            self.pushButton.setText(_translate("Pregunta4", "SIGUIENTE PREGUNTA"))
            ...
            self.Sustancia2Frame = QtWidgets.QFrame(Pregunta4)
            ...
            QtCore.QMetaObject.connectSlotsByName(Pregunta4)

            _translate = QtCore.QCoreApplication.translate
            Pregunta4.setWindowTitle(_translate("Pregunta4", "Pregunta4"))
            self.LabelSustancia.setText(_translate("Pregunta4", f"{lista_sustancias_escogidas[0]}"))
            self.SeleccionNunca.setText(_translate("Pregunta4", "Nunca"))
            self.Seleccion1o2Veces.setText(_translate("Pregunta4", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes.setText(_translate("Pregunta4", "Cada mes \n"""))
            self.SeleccionCadaSemana.setText(_translate("Pregunta4", "Cada semana"))
            ...
            self.LabelSustancia2.setText(_translate("Pregunta4", f"{lista_sustancias_escogidas[1]}"))
            self.SeleccionNunca2.setText(_translate("Pregunta4", "Nunca"))
            self.Seleccion1o2Veces2.setText(_translate("Pregunta4", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes2.setText(_translate("Pregunta4", "Cada mes \n"""))
            self.SeleccionCadaSemana2.setText(_translate("Pregunta4", "Cada semana"))
            self.radioButton2.setText(_translate("Pregunta4", "A diario o casi diario"))
            ...
            self.Sustancia3Frame = QtWidgets.QFrame(Pregunta4)
            ...
            self.LabelSustancia3.setText(_translate("Pregunta4", f"{lista_sustancias_escogidas[2]}"))
            self.SeleccionNunca3.setText(_translate("Pregunta4", "Nunca"))
            self.Seleccion1o2Veces3.setText(_translate("Pregunta4", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes3.setText(_translate("Pregunta4", "Cada mes \n"""))
            self.SeleccionCadaSemana3.setText(_translate("Pregunta4", "Cada semana"))
            self.radioButton3.setText(_translate("Pregunta4", "A diario o casi diario"))
            ...
            self.Sustancia4Frame = QtWidgets.QFrame(Pregunta4)
            ...
            self.SeleccionCadaMes3.setText(_translate("Pregunta4", "Cada mes \n"""))
            self.SeleccionCadaSemana3.setText(_translate("Pregunta4", "Cada semana"))
            self.radioButton3.setText(_translate("Pregunta3", "A diario o casi diario"))

            self.LabelSustancia4.setText(_translate("Pregunta4", f"{lista_sustancias_escogidas[3]}"))
            self.SeleccionNunca4.setText(_translate("Pregunta4", "Nunca"))
            self.Seleccion1o2Veces4.setText(_translate("Pregunta4", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes4.setText(_translate("Pregunta4", "Cada mes \n"""))
            self.SeleccionCadaSemana4.setText(_translate("Pregunta4", "Cada semana"))
            self.radioButton4.setText(_translate("Pregunta4", "A diario o casi diario"))
            ...
            self.Sustancia5Frame = QtWidgets.QFrame(Pregunta4)
            ...
            self.LabelSustancia5.setText(_translate("Pregunta4", f"{lista_sustancias_escogidas[4]}"))
            self.SeleccionNunca5.setText(_translate("Pregunta4", "Nunca"))
            self.Seleccion1o2Veces5.setText(_translate("Pregunta4", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes5.setText(_translate("Pregunta4", "Cada mes \n"""))
            self.SeleccionCadaSemana5.setText(_translate("Pregunta4", "Cada semana"))
            self.radioButton5.setText(_translate("Pregunta4", "A diario o casi diario"))
            ...
            self.Sustancia6Frame = QtWidgets.QFrame(Pregunta4)
            ...
            self.LabelSustancia6.setText(_translate("Pregunta4", f"{lista_sustancias_escogidas[5]}"))
            self.SeleccionNunca6.setText(_translate("Pregunta4", "Nunca"))
            self.Seleccion1o2Veces6.setText(_translate("Pregunta4", "1 ó 2 veces \n"""))
            self.SeleccionCadaMes6.setText(_translate("Pregunta4", "Cada mes \n"""))
            self.SeleccionCadaSemana6.setText(_translate("Pregunta4", "Cada semana"))
            self.radioButton6.setText(_translate("Pregunta4", "A diario o casi diario"))

    def abrir_pregunta5(self):
        ...
        self.pregunta5 = QMainWindow()
        self.ui = Ui_Pregunta5()
        self.ui.setupUi(self.pregunta5, self.Lista_sustancias,lista_puntajes_a_pasar)
        self.pregunta5.showFullScreen()